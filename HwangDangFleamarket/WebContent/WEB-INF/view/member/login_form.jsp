						...
						$("#login")
								.on(
										...
										function() {
											...
											//구매중 로그인페이지로 온경우 이동 
											if ($("#errorMsg").html().trim() == null ||  $("#errorMsg").html().isempty() ) {
												// 로그인후 상품디테일페이지로 이동 
			...
			<table>
				...
				<tr class="trInput">
					<td colspan="2" align="center"><input
						class="btn btn-lg btn-success btn-block" type="submit" value="로그인"
						id="login" /> <input class="btn btn-lg btn-primary btn-block"
